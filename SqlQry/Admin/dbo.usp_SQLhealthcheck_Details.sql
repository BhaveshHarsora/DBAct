...
/****************************************************************************/  
/****************************************************************************/ 
IF EXISTS ( SELECT	1 FROM	SYSOBJECTS WHERE	ID = OBJECT_ID(N'dbo.usp_SQLhealthcheck_Details') AND [TYPE] = 'P')
BEGIN
    DROP PROCEDURE dbo.usp_SQLhealthcheck_Details;
END
GO
CREATE PROCEDURE dbo.usp_SQLhealthcheck_Details
AS
BEGIN  
