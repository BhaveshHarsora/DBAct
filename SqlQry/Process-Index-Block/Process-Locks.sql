...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_Locks]') AND type IN (N'P', N'PC'))
	DROP PROCEDURE dbo.usp_Locks;
GO
  
  
CREATE PROCEDURE dbo.usp_Locks
(
	 @Mode int = 2
